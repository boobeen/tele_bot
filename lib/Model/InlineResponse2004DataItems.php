...
/**
 * InlineResponse2004DataItems Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2004DataItems implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_4_data_items';
...
'dialog_count' => 'getDialogCount'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['dialog_count'] = isset($data['dialog_count']) ? $data['dialog_count'] : null;
    }
     ...
     * Sets state
     *
     * @param string $state Статус канала
     *
     * @return $this
     */
    ...
    {
        return $this->container['dialog_count'];
    }

    /**
     * Sets dialog_count
     *
     * @param int $dialog_count Количество открытых диалогов канала
     *
     * @return $this
     */
    public function setDialogCount($dialog_count)
    {
        $this->container['dialog_count'] = $dialog_count;
