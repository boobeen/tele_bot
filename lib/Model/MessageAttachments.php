...
/**
 * MessageAttachments Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessageAttachments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'message_attachments';
...
'type' => 'getType'    ];
     ...
     * Sets id
     *
     * @param string $id Идентификатор аттачмента
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url Ссылка на аттачмент
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Тип аттачмента
     *
     * @return $this
     */
