...
/**
 * MessageClient Class Doc Comment
 *
 * @category Class
 * @description Массив данных клиента. NULL, если это сообщение пришло от оператора
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessageClient implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'message_client';
...
'avatar' => 'getAvatar'    ];
     ...
     * Sets avatar
     *
     * @param string $avatar Ссылка на аватар клиента
     *
     * @return $this
     */
