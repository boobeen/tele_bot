...
/**
 * MessageOperator Class Doc Comment
 *
 * @category Class
 * @description Массив данных оператора. NULL, если это сообщение пришло от клиента
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessageOperator implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'message_operator';
...
'avatar' => 'getAvatar'    ];
     ...
     * Sets id
     *
     * @param string $id Идентификатор оператора
     *
     * @return $this
     */
     ...
     * Sets avatar
     *
     * @param string $avatar Ссылка на аватар оператора
     *
     * @return $this
     */
